...
namespace App\Models {
     ...
     * @property string|null $training_enddate
     * @property string|null $training_startdate
     * @property string|null $requirements_enddate
     * @property string|null $requirements_startdate
     * @property string|null $contract_offers_enddate
     * @property string|null $contract_offers_startdate
     * @property string|null $final_interviews_enddate
     * @property string|null $final_interviews_startdate
     * @property string|null $initial_interviews_enddate
     * @property string|null $initial_interviews_startdate
     * @property string|null $source_testing_enddate
     * @property string|null $source_testing_startdate
     * @property string|null $contact_schools_enddate
     * @property string|null $contact_schools_startdate
     * @property array|null $wbs
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<ResourceSchedule>|ResourceSchedule whereBatchName($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<ResourceSchedule>|ResourceSchedule whereWbs($value)
