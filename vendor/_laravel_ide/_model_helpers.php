...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs whereModule($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs whereActivity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs whereIpAddress($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs whereCreatedBy($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs whereUpdatedBy($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs whereCreateTime($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs whereUpdateTime($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Logs>|Logs query()
