...
const sourceTypes = props.sourceTypes
    ? Object.entries(props.sourceTypes).map(([value, label]) => ({
          value: Number(value),
          label,
      }))
    : [];
...
const sources = props.sources
    ? Object.entries(props.sources).map(([value, label]) => ({
          value: Number(value),
          label,
      }))
    : [];
...
const genders = props.genders
    ? Object.entries(props.genders).map(([value, label]) => ({
          value: Number(value),
          label,
      }))
    : [];
...
const form = useForm({
    ...
    school_graduated_from: props.applicant?.school_graduated_from || '',
    course: props.applicant?.course || '',
    year_attended: props.applicant?.year_attended || '',
    others: props.applicant?.others || '',
    spouse_details: props.applicant?.spouse_details || '',
    children: props.applicant?.children || '',
    father_details: props.applicant?.father_details || '',
    mother_details: props.applicant?.mother_details || '',
    sibling_details: props.applicant?.sibling_details || '',
    emergency_contact_name: props.applicant?.emergency_contact_name || '',
    emergency_contact_number: props.applicant?.emergency_contact_number || '',
    emergency_contact_address: props.applicant?.emergency_contact_address || '',
...
const rules = {
    ...
    japanese_background: (val: string | number) =>
...
watch(
    () => form.japanese_background,
    () => validateField('japanese_background'),
);
watch(
    () => form.japanese_level,
    () => validateField('japanese_level'),
);
...
function submit() {
    form.put(`/intermediate/applicants/${props.applicant.id}/update`, {
...
<template>
    <AppLayout>
        ...
        <div class="page-header">
            <h2 class="page-title">Edit Intermediate Applicant</h2>
        </div>
            ...
            <div class="card create-user-card">
                <form @submit.prevent="submit">
                    <div class="form-group">
                        ...
                        <span v-if="form.errors.source_type" class="error">{{
                    ...
                    <div class="form-row">
                        <div class="form-group half">
                            ...
                            <span
                                v-if="!isSourceDisabled && form.errors.source"
                                class="error"
                    ...
                    <div class="form-row name-fields">
                        <div class="form-group last-first">
                            ...
                            />
                            <span v-if="form.errors.last_name" class="error">{{
                    ...
                    <div class="form-row">
                        <div class="form-group half">
                            ...
                            <span v-if="form.errors.gender" class="error">{{
                                form.errors.gender
                            }}</span>
                        </div>
                        ...
                        <div class="form-group half">
                            ...
                            <span v-if="form.errors.birthdate" class="error">{{
                    ...
                    <div class="form-row">
                        <div class="form-group half">
                            ...
                            <span v-if="form.errors.age" class="error">{{
                                form.errors.age
                            }}</span>
                        </div>
                        ...
                        <div class="form-group half">
                            ...
                            <input
                                ...
                                placeholder="Address"
                            />
                            <span v-if="form.errors.address" class="error">{{
                                form.errors.address
                            }}</span>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group half">
                            ...
                            <span
                                ...
                                class="error"
                                >{{ form.errors.email_address }}</span
                            >
                        </div>
                        ...
                        <div class="form-group half">
                            ...
                            />
                            <span v-if="form.errors.contact_no" class="error">{{
                    ...
                    <div class="form-row">
                        <div class="form-group half">
                            ...
                            />
                            <span
                                v-if="form.errors.school_graduated_from"
                                class="error"
                                >{{ form.errors.school_graduated_from }}</span
                            >
                        </div>
                        ...
                        <div class="form-group half">
                            ...
                            <input
                                ...
                                placeholder="Course"
                            />
                            <span v-if="form.errors.course" class="error">{{
                                form.errors.course
                            }}</span>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group half">
                            ...
                            <input
                                ...
                                placeholder="e.g. 2007-2011, etc."
                            />
                            <span
                                v-if="form.errors.year_attended"
                                class="error"
                                >{{ form.errors.year_attended }}</span
                            >
                        </div>
                        ...
                        <div class="form-group half">
                            ...
                            <input
                                type="text"
                                v-model="form.others"
                                placeholder="Indicate other schools and degrees taken."
                            />
                            <span v-if="form.errors.others" class="error">{{
                                form.errors.others
                            }}</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="field-label-required required"
                            >Japanese Background</label
                        >
                        <div class="radio-group">
                            <label
                                v-for="j in japaneseBackgrounds"
                                :key="j.value"
                            >
                                <input
                                    type="radio"
                                    :value="j.value"
                                    v-model="form.japanese_background"
                                />
                                {{ j.label }}
                            </label>
                        </div>
                        <span
                            v-if="form.errors.japanese_background"
                            class="error"
                            >{{ form.errors.japanese_background }}</span
                        >
                    </div>
                    ...
                    <div class="form-group">
                        <label
                            :class="[
                                isJapaneseLevelDisabled
                                    ? 'field-label'
                                    : 'field-label-required required',
                            ]"
                            >Japanese Level</label
                        >
                        <select
                            v-model="form.japanese_level"
                            :disabled="isJapaneseLevelDisabled"
                        >
                            <option disabled value="">Select Level</option>
                            <option
                                v-for="j in japaneseLevels"
                                :key="j.value"
                                :value="j.value"
                            >
                                {{ j.label }}
                        ...
                        <span
                            ...
                            "
                            class="error"
                            >{{ form.errors.japanese_level }}</span
                        >
                    </div>

                    <div class="form-group">
                        <label class="field-label"
                            >Japanese Background Remarks</label
                        >
                        <textarea v-model="form.background_remarks"></textarea>
                        <span
                            v-if="form.errors.background_remarks"
                            class="error"
                            >{{ form.errors.background_remarks }}</span
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            v-model="form.spouse_details"
                            placeholder="NAME - AGE - OCCUPATION (e.g. Juan Dela Cruz - 34 - Nurse)"
                        ></textarea>
                        <span v-if="form.errors.spouse_details" class="error">{{
                            form.errors.spouse_details
                        }}</span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        />
                        <span v-if="form.errors.children" class="error">{{
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            v-model="form.father_details"
                            placeholder="NAME - AGE - OCCUPATION (e.g. Juan Dela Cruz - 34 - Nurse)"
                        ></textarea>
                        <span v-if="form.errors.father_details" class="error">{{
                            form.errors.father_details
                        }}</span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            v-model="form.mother_details"
                            placeholder="NAME - AGE - OCCUPATION (e.g. Juan Dela Cruz - 34 - Nurse)"
                        ></textarea>
                        <span v-if="form.errors.mother_details" class="error">{{
                            form.errors.mother_details
                        }}</span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            v-model="form.sibling_details"
                            placeholder="NAME - AGE - OCCUPATION (e.g. Juan Dela Cruz - 34 - Nurse)"
                        ></textarea>
                        <span
                            v-if="form.errors.sibling_details"
                            class="error"
                            >{{ form.errors.sibling_details }}</span
                        >
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group half">
                            ...
                            />
                            <span
                                v-if="form.errors.emergency_contact_number"
                                class="error"
                                >{{
                        ...
                        <div class="form-group half">
                            ...
                            />
                            <span
                                v-if="form.errors.emergency_contact_address"
                                class="error"
                                >{{
                    ...
                    <div class="form-group">
                        ...
                        <span v-if="form.errors.remarks" class="error">{{
                            form.errors.remarks
                        }}</span>
                    </div>
                    ...
                    <div class="form-actions">
                        <Link
                            :href="`/intermediate/applicants/${props.applicant.id}`"
