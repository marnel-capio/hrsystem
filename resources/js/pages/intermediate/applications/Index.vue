                ...
                <div v-if="flashMessages.success" key="success"
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <pre
                                class="whitespace-pre-wrap text-sm leading-relaxed font-medium">{{ flashMessages.success }}</pre>
                        </div>
            ...
            <TransitionGroup name="toast" tag="div">
                <div v-if="flashMessages.error" key="error"
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <pre
                                class="whitespace-pre-wrap text-sm leading-relaxed font-medium">{{ flashMessages.error }}</pre>
                        </div>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                ...
                <div class="flex gap-2 flex-nowrap">
                    <Link v-if="props.userPermissions != 5 && props.userPermissions != 6"
                        href="/action/applications/register" class="!bg-[#1C7BA5] btn-primary whitespace-nowrap">
                        Create ACTION Application
                    </Link>
                    <input type="file" ref="fileInput" class="hidden" accept=".xlsx,.csv" />
                    <button v-if="props.userPermissions != 5 && props.userPermissions != 6" type="button"
                        @click="openImportModal" class="btn-primary whitespace-nowrap">
                        Upload Applications from Google Forms
                    </button>
                </div>
            </div>
                        ...
                        <tbody>
                            <tr v-for="app in paginatedSchedules" :key="app.id">
                                ...
                                <td class="border px-3 py-2">
                                    <Link :href="`/action/applications/${app.id}`"
