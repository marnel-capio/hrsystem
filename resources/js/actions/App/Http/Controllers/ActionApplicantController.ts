 ...
 * @see app/Http/Controllers/ActionApplicantController.php:47
 ...
 * @see app/Http/Controllers/ActionApplicantController.php:64
...
const ActionApplicantController = { show, edit, update, index, create, store, checkEmail }
